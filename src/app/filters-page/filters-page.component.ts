...
export class FiltersPageComponent implements OnInit {
  ...
  testShops = [
    ...
    },
    {
        ...
        "description": "KP Astrology - Prediction Reports, Training, Astrology Software",
        "phoneNumber": "9701924365",
        "timeFrom": "10:00:00",
        "timeTo": "22:00:00",
        "address": "{\"address\":\"G-1908, Rainbow Vistas @ Rock Garden, Green Hills Road, Kukatpally , Hyderabad, Telangana, India, 500018\",\"building\":\"Rainbow Vistas @ Rock Garden\",\"city\":\"Hyderabad\",\"country\":\"India\",\"houseNumber\":\"G-1908\",\"locality\":\"Green Hills Road, Kukatpally \",\"pincode\":\"500018\",\"state\":\"Telangana\"}",
  ...
  categories: string[] = ["Electronics", "Hospitals", "Category 3", "Category 4", "Category 5"]
  distances: number[] = [2, 4, 6, 8, 10]
  selectedDistance: number = 8
  constructor(private shopsService: ShopsService) {
    this.loading = true
    let userloging: UserLogin = {email: "abhishekmeher3@gmail.com", password:"KtKiLa"}
    this.shopsService.getNearByShops(userloging)
      .subscribe(shops => {
          this.shops = shops
          this.loading = false
      }, error => {
